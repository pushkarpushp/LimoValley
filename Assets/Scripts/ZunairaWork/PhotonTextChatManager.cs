...
using Photon.Pun;
#endif
    public class PhotonTextChatManager : MonoBehaviour, IChatClientListener
    {
        ...
        public InputField InputFieldChat;   // set in inspector
                                            // public InputField InputFieldChatp;   // set in inspector
        ...
        public void OnPrivateMessage(string sender, object message, string channelName)
        {
            ...
            {
                Debug.Log("sending private mesge before show");
